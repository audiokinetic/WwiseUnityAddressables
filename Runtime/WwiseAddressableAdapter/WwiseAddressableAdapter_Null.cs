...
public class WwiseAddressableAdapter_Null
{
...
#if UNITY_EDITOR
        //24.1.0 to 24.1.6 doesn't use the adapter. Starting 24.1.11, the Unity integration sets the define through the setup wizard.
        if (currentMinor is > 6 and < 11)
        {
    ...
    {
        string adapterVersion = "ADDRESSABLES_API_BREAK_AK_UTILITIES";
