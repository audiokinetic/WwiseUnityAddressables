...
namespace AK.Wwise.Unity.WwiseAddressables
{
	public static class AkAssetUtilities
	{
		...
		public static string GetSoundbanksPath()
		{
			...
			{
				WwiseAddressableAdapter.Instance.WwiseError("Wwise Addressables: You need to set the RootOutputPath in the Wwise Editor settings or assets will not be properly imported.");
				return string.Empty;
			}
			...
			{
				UnityEngine.Debug.LogWarning("Wwise Addressables: The RootOutputPath in the Wwise Editor settings is set within the StreamingAssets folder. It is recommended to not set it in this folder.");
			}
